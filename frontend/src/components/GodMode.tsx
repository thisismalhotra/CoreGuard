  ...
  const scenarios: Scenario[] = [
    {
      ...
      description: "Scout detects 3x demand surge on FL-001-T. Solver runs MRP, reallocates from FL-001-S, Buyer issues POs.",
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: "CREE Inc. goes offline. Solver identifies LED-201 impact, switches to alternate supplier, Buyer raises emergency PO.",
      icon: Flame,
    ...
    },
    {
      ...
      description: "Inspector detects hardness and dimension violations in incoming CH-231 Body Tube batch. Quarantines stock, triggers reorder.",
      icon: XCircle,
    ...
    },
    {
      ...
      description: "800% spike forces a PO exceeding the $5,000 financial guardrail. Buyer blocks it with PENDING_APPROVAL — the LLM cannot override.",
      icon: DollarSign,
    ...
    },
    {
      id: "blackout",
      label: "Full Blackout",
      description: "ALL suppliers go offline simultaneously. Solver exhausts every procurement option and escalates a CRITICAL alert to the COO.",
      icon: WifiOff,
  ...
  const partAgentScenarios: Scenario[] = [
    {
      id: "slow-bleed",
      label: "Slow Bleed",
      description: "Gradual burn rate increase with no external trigger. Pulse is the ONLY agent that detects the silent drift toward stockout.",
      icon: Activity,
    ...
    },
    {
      ...
      description: "Pulse initially reports all-clear, then Auditor reveals ghost and suspect stock hiding behind healthy numbers.",
      icon: Ghost,
    ...
    },
    {
      ...
      description: "FL-001-T and FL-001-S compete for shared CH-231 Body Tube. Pulse detects contention, Solver applies criticality-based prioritization.",
      icon: GitMerge,
  ...
  const supplyChainScenarios: Scenario[] = [
    {
      ...
      description: "Blanket PO with CREE is 90% consumed. Buyer evaluates: extend contract, spot buy at premium, or renegotiate terms.",
      icon: FileText,
    ...
    },
    {
      id: "tariff-shock",
      label: "Tariff Shock",
      description: "25% tariff hits Chinese suppliers overnight. Solver recalculates costs and evaluates switching to US/EU alternates.",
      icon: Globe,
    ...
    },
    {
      id: "moq-trap",
      label: "MOQ Trap",
      description: "Need 80 LEDs but MOQ is 500. Buyer compares: buy excess and eat carry cost, or pay 15% small-lot premium.",
      icon: Box,
    ...
    },
    {
      ...
      description: "VIP military order doubles to 400 units with 21-day deadline. Solver ring-fences inventory, displacing lower-priority orders.",
      icon: Shield,
    ...
    },
    {
      id: "seasonal-ramp",
      label: "Seasonal Ramp",
      description: "Peak season demand arrives 40% above forecast across all product lines. Scout detects deviation, Solver pre-positions inventory.",
      icon: Sun,
  ...
  const demandHorizonScenarios: Scenario[] = [
    {
      ...
      description: "Demand for CH-231 is 200+ days out. Scout monitors only — no PO generated. Cash preserved for nearer-term needs.",
      icon: Clock,
    ...
    },
    {
      ...
      description: "Demand for CH-231 in 90 days. Solver explodes BOM, Buyer drafts standard PO to primary supplier.",
      icon: Clock,
    ...
    },
    {
      ...
      description: "Demand for CH-231 in 10 days — inside supplier lead time! Pulse defends stock, Buyer pivots to secondary supplier.",
      icon: Clock,
      color: "bg-red-600 hover:bg-red-500",
        ...
        >
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h3 className="text-sm font-semibold text-foreground">Pulse Spotlight</h3>
            </div>
            <p className="text-xs text-muted-foreground">
              Scenarios where Pulse&apos;s autonomous monitoring drives the response
            </p>
          </div>
          {collapsed["partAgent"] ? (
            <ChevronDown className="h-4 w-4 text-muted-foreground" />
